...
${GAMES_JSON.length} ${(GAMES_JSON.length - unfundedGames.length) === 1 ? "game" : "games"}.
Currently, ${unfundedGames.length > 0 ? unfundedGames.length : 0} 
${unfundedGames.length === 1 ? "game remains" : "games remain"} unfunded. We need your help to fund these 
amazing games!`;
